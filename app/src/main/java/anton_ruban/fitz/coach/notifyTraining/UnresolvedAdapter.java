...
public class UnresolvedAdapter extends RecyclerView.Adapter<UnresolvedAdapter.ViewHolder> {
    private Context context;
    private List<AddTrainingReq> listResponse;


    public UnresolvedAdapter(Context context, List<AddTrainingReq> list){
    ...
    public void setListUnResolved(List<AddTrainingReq> res) {
